...
@Tag(
        ...
        description = "CRED REST APIs in Bank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountController {
    ...
    @Operation(
            ...
            description = "Get Currently Maven Version"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Retry(name = "getMavenVersion", fallbackMethod = "getMavenVersionFallback")
    ...
    public ResponseEntity<String> getMavenVersionFallback(Throwable throwable){
        logger.debug("Fallback() method Invoked");
        return ResponseEntity
                .status(HttpStatus.OK)
                .body("Maven 3.5.1");
    }
